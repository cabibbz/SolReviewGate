  ...
  return <main className="shell">
    ...
    <div className="content">
      ...
      <div className="main-view-content">
        ...
        {view === "lab" && <section className="lab-view"><div className="panel"><div className="panel-header"><h2>Run configuration</h2><span className="status-pill">Sample</span></div><div className="run-config-facts"><div><span>Model</span><strong>gpt 5.6 sol</strong></div><div><span>Reasoning</span><strong>medium</strong></div><div><span>Protocol</span><strong>alignment v1</strong></div></div><div className="demo-panel-copy">The paired phone chooses the reviewing model, the reasoning effort, and the alignment protocol without redeploying. A comparison set runs one packet under several configurations, and the operator decides which response reaches Claude. Unselected candidates stay on the phone.</div></div><div className="panel"><div className="panel-header"><h2>Alignment outcomes</h2><span className="status-pill">3 runs</span></div><div className="lab-metrics"><div><span>Release rate</span><strong>67%</strong></div><div><span>Released</span><strong>2</strong></div><div><span>Model withheld</span><strong>1</strong></div><div><span>Wrapper blocked</span><strong>0</strong></div><div><span>System failure</span><strong>0</strong></div><div><span>Unclassified</span><strong>0</strong></div></div><div className="demo-panel-copy">Protocol fingerprints separate experimental configurations so unlike runs are not pooled. Private model responses stay visible only to the paired phone.</div></div></section>}
      </div>
